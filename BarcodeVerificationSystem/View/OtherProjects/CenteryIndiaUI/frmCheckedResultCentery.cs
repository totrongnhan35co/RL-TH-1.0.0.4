...
{
    public partial class FrmCheckedResultCentery : Form
    {
        public FrmMainCentery _frmParent = null;
        ...
        public FrmCheckedResultCentery()
        {
            InitializeComponent();
        }
        ...
        private void AssignColumnNameToTable(List<string> values)
        {
            ...
            FrmMainCentery.AutoResizeColumnWith(dgvCheckedResult, defaultRecord, 2);
