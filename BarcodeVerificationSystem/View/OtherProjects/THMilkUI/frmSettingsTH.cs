...
{
    public partial class FrmSettingsTH: Form
    {
        #region Properties
        ...
        private void InitControls()
        {
            ...
            if ((ProjectLabel.IsTHMilk && Shared.UserPermission.ProductionSettings) || currentUser != "Operator")
            {
                ...
                ucProductionTHSetting ucApiSetting = new ucProductionTHSetting();
