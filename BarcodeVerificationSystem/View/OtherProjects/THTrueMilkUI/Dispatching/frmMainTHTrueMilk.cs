...
using BarcodeVerificationSystem.Modules.ReliableDataSender.Services.THTrueMilk;
                        ...
                        if (Application.OpenForms.Count > 0)
                        {
                            ...
                            mainForm.Invoke(new Action(() =>
                            {
                                CustomMessageBox.Show(
                                    "B?n có mu?n dùng chương tr?nh ? \n S? lư?ng m? đ? in vư?t ngư?ng" +
                                    "\n " + $"S? lư?ng m? đ? in : {currentPrintedCodeInfo.amount}",
                                    "M? vư?t ngư?ng",
        ...
        private void ActionChanged(object sender, EventArgs e)
        {
            ...
            else if (sender == btnDatabase || sender == pnlPrintedCode)
            {
                ...
                if (_FormPreviewDatabase == null || _FormPreviewDatabase.IsDisposed)
                {
                    ...
                    var updatedColumns = _DatabaseColunms
                                            .Take(2)
                                            .Concat(new[] { "Tr?ng thái SaaS", "Tr?ng thái HUB" })
            ...
            else if(sender == syncDataBtn)
            {
                ...
                else
                {
                    ...
                    CustomMessageBox.Show("H? th?ng đang v?n hành và đang th?c hi?n đ?ng b?!", Lang.Info, MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
            ...
            for (int i = 0; i < Shared.Settings.CameraList.Count; i++)
            {
                if (i < _LabelStatusCameraList.Count)
                {
                    ...
                    else
                    {
                        ...
                        {
                            if (ProjectLabel.IsTHTrueMilk && !Shared.Settings.IsManufacturingMode)
                            {
                                return;
                            }
