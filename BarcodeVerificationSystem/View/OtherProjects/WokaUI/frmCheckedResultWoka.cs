...
{
    public partial class FrmCheckedResultWoka : Form
    {
        public FrmMainWoka _frmParent = null;
        ...
        private void AssignColumnNameToTable(List<string> values)
        {
            ...
            FrmMainWoka.AutoResizeColumnWith(dgvCheckedResult, defaultRecord, 2);
