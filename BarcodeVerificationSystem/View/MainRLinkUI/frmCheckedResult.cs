            ...
            try
            {
                ...
                else
                {
                    for (int i = 0; i < _CheckedResult.Count(); i++)
                    {
                        ...
                        if (filler.Equals("camera") || filler.Equals("barcode scanner"))
                        {
                            checkedResult = _CheckedResult[i][_frmParent.Index_Device].ToLower();
                        }
                        else
                        {
                            checkedResult = _CheckedResult[i][_frmParent.Index_Result].ToLower();
                        }
