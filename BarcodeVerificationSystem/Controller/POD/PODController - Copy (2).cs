...
//                    {
//                        if (_isRunning && _TcpClient?.Client?.Connected == true)
//                        {
//                            try { _NetworkStream?.WriteByte(0x0D); _NetworkStream?.Flush(); } catch { }
//                        }
//                    }, null, 5000, 5000);
//                }
...
//        {
//            if (_Port2 <= 0) return true;  // Skip nếu Port2 = 0 (THTrueMilk chỉ dùng 1 port)
//            try
//            {
